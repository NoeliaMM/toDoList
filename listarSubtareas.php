...
$sql = "SELECT * FROM subtareas WHERE tareaID=$tareaID";
...
if ($resultado->num_rows === 0) {
   ...
   echo json_encode(array('subtareas'=> array()));
   exit;
}

$resultados = array();

while ($subtareas = $resultado->fetch_assoc()) {
   array_push($resultados,array('id'=>$subtareas['id'],'nombre'=>$subtareas['nombre']));
}
